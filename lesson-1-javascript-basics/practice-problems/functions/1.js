...
// and returns their average. Call the function with three numbers and log the
// result.
...
// Our current average function only takes three numbers; we might need to
// write additional functions if we want to work with different numbers of data
// points. A better solution, though, is to change the function to accept an
// array of arbitrary length. We can calculate the average by looping over the
// array elements to calculate the total, then divide by the array length.
...
// }
//
// console.log(average([1, 2, 3, 7, 10]));
...
// everything from average into sum, except for the final return statement. The
// sum function should return the total, and average should call the sum
...
// to determine the average of all the numbers in an arbitrary array of
// numbers. Create an array named temperatures and store five temperature
// values in it. Find the average temperature by passing the array to the
// average function and log the result.

let temperatures = [82, 79, 73, 90, 92];
